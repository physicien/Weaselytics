...
To run tests locally, type the following command: pytest weaselytics/tests/

To lint files using ruff: ruff check weaselytics/
-->
...
- [ ] Verified that `ruff check weaselytics/` passes, if applicable.
